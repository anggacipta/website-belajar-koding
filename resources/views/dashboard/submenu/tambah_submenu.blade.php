                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('store.submenu') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="simpleinput" name="nama_submenu" class="form-control">
                            </div>
                            <div class="mb-3">
                                <label for="simpleinput" class="form-label">Summary Submenu</label>
                                <textarea name="summary" class="form-control" rows="10" maxlength="50"></textarea>
                            </div>
                            ...
                            <div class="form-group col-md-6 mb-3">
                                <img src="" class="img-thumbnail" width="300" height="300"
